    ...
    return RepositoryProvider<WeatherRepository>(
      ...
      child: BlocProvider(
        create: (context) => CurrentWeatherPositionCubit(
            context.read<WeatherRepository>(), position)
          ..getWeather(),
        child: BlocBuilder<CurrentWeatherPositionCubit,
      ...
      child: Row(
        children: [
          ...
          _componentInformation(
            ...
            information: '${weather.daily[0].feelsLike.day}',
          ),
          spaceVertical(),
          _componentInformation(
            icon: Icons.air,
      ...
      children: [
        Column(
          children: [
            ...
            spaceHeight(),
            Text(min, style: styleHeadingBold),
          ],
        ),
        Column(
          children: [
            ...
            spaceHeight(),
            Text(max, style: styleHeadingBold),
          ],
        ),
      ],
    );
